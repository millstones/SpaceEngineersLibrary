...
namespace IngameScript
{
  ...
  public class TouchUiKit
  {
    ...
    Func<IMyCubeBlock, IMyTextSurface, object> _createTouchScreen;
    Action<IMyCubeBlock, IMyTextSurface> _removeTouchScreen;
    Action<string> _addSurfaceCoords;
    Action<string> _removeSurfaceCoords;
    ...
    /// <returns></returns>
    public object CreateTouchScreen(IMyCubeBlock block, IMyTextSurface surface) =>
      _createTouchScreen?.Invoke(block, surface);
    ...
    public void RemoveTouchScreen(IMyCubeBlock block, IMyTextSurface surface) =>
      _removeTouchScreen?.Invoke(block, surface);
    ...
    public TouchUiKit(Sandbox.ModAPI.Ingame.IMyTerminalBlock pb)
    {
      ...
      if (delegates != null)
      {
        ...
        AssignMethod(out _apiDel.TouchScreen_CompareWithBlockAndSurface,
          delegates["TouchScreen_CompareWithBlockAndSurface"]);
        ...
        AssignMethod(out _apiDel.TouchScrollView_GetScrollAlwaysVisible,
          delegates["TouchScrollView_GetScrollAlwaysVisible"]);
        AssignMethod(out _apiDel.TouchScrollView_SetScrollAlwaysVisible,
          delegates["TouchScrollView_SetScrollAlwaysVisible"]);
    ...
    void AssignMethod<T>(out T field, object method) => field = (T) method;
  }
  ...
  public class TouchUiKitDelegator
  {
    ...
    public Action<object, IMyCubeBlock, IMyTextSurface> TouchApp_InitApp;
  ...
  public abstract class WrapperBase<TT> where TT : TouchUiKitDelegator
  {
    ...
    static protected T[] WrapArray<T>(object[] objArray, Func<object, T> ctor)
    {
      ...
      for (int i = 0; i < objArray.Length; i++)
        newArray[i] = Wrap(objArray[i], ctor);
      return newArray;
    }

    internal object InternalObj { get; private set; }

    public WrapperBase(object internalObject)
    {
      InternalObj = internalObject;
    }
  }
  ...
  public class TouchScreen : WrapperBase<TouchUiKitDelegator>
  {
    ...
    public IMyCubeBlock Block => Api.TouchScreen_GetBlock.Invoke(InternalObj);

    public IMyTextSurface Surface => Api.TouchScreen_GetSurface.Invoke(InternalObj);

    public int Index => Api.TouchScreen_GetIndex.Invoke(InternalObj);

    public bool IsOnScreen => Api.TouchScreen_IsOnScreen.Invoke(InternalObj);

    public Vector2 CursorPosition => Api.TouchScreen_GetCursorPosition.Invoke(InternalObj);

    public float InteractiveDistance => Api.TouchScreen_GetInteractiveDistance.Invoke(InternalObj);

    public void SetInteractiveDistance(float distance) =>
      Api.TouchScreen_SetInteractiveDistance.Invoke(InternalObj, distance);

    public int Rotation => Api.TouchScreen_GetRotation.Invoke(InternalObj);

    public bool CompareWithBlockAndSurface(IMyCubeBlock block, IMyTextSurface surface) =>
      Api.TouchScreen_CompareWithBlockAndSurface.Invoke(InternalObj, block, surface);
  ...
  public class TouchCursor : WrapperBase<TouchUiKitDelegator>
  {
    ...
    public bool Active
    {
      get { return Api.TouchCursor_GetActive.Invoke(InternalObj); }
      set { Api.TouchCursor_SetActive.Invoke(InternalObj, value); }
    }

    public float Scale
    {
      get { return Api.TouchCursor_GetScale.Invoke(InternalObj); }
      set { Api.TouchCursor_SetScale.Invoke(InternalObj, value); }
    }

    public Vector2 Position => Api.TouchCursor_GetPosition.Invoke(InternalObj);

    public bool IsInsideArea(float x, float y, float z, float w) =>
      Api.TouchCursor_IsInsideArea.Invoke(InternalObj, x, y, z, w);
  ...
  public class ClickHandler : WrapperBase<TouchUiKitDelegator>
  {
    ...
    /// </summary>
    public Vector4 HitArea
    {
      get { return Api.ClickHandler_GetHitArea.Invoke(InternalObj); }
      set { Api.ClickHandler_SetHitArea.Invoke(InternalObj, value); }
    }
    ...
    public void UpdateStatus(TouchScreen screen) =>
      Api.ClickHandler_UpdateStatus.Invoke(InternalObj, screen.InternalObj);
  }
  ...
  public class TouchTheme : WrapperBase<TouchUiKitDelegator>
  {
    ...
    public Color BgColor => Api.TouchTheme_GetBgColor.Invoke(InternalObj);
    ...
    /// </summary>
    public Color WhiteColor => Api.TouchTheme_GetWhiteColor.Invoke(InternalObj);

    public Color MainColor => Api.TouchTheme_GetMainColor.Invoke(InternalObj);
    ...
    public float Scale
    {
      get { return Api.TouchTheme_GetScale.Invoke(InternalObj); }
      set { Api.TouchTheme_SetScale.Invoke(InternalObj, value); }
    }

    public string Font
    {
      get { return Api.TouchTheme_GetFont.Invoke(InternalObj); }
      set { Api.TouchTheme_SetFont.Invoke(InternalObj, value); }
    }
    ...
    public Vector2 MeasureStringInPixels(string text, string font, float scale) =>
      Api.TouchTheme_MeasureStringInPixels.Invoke(InternalObj, text, font, scale);
  }
  ...
  public abstract class TouchElementBase : WrapperBase<TouchUiKitDelegator>
  {
    ...
    public bool Enabled
    {
      get { return Api.TouchElementBase_GetEnabled.Invoke(InternalObj); }
      set { Api.TouchElementBase_SetEnabled.Invoke(InternalObj, value); }
    }
    ...
    {
      get { return Api.TouchElementBase_GetAbsolute.Invoke(InternalObj); }
      set { Api.TouchElementBase_SetAbsolute.Invoke(InternalObj, value); }
    }
    ...
    {
      get { return (ViewAlignment) Api.TouchElementBase_GetSelfAlignment.Invoke(InternalObj); }
      set { Api.TouchElementBase_SetSelfAlignment.Invoke(InternalObj, (byte) value); }
    }
    ...
    {
      get { return Api.TouchElementBase_GetPosition.Invoke(InternalObj); }
      set { Api.TouchElementBase_SetPosition.Invoke(InternalObj, value); }
    }
    ...
    {
      get { return Api.TouchElementBase_GetMargin.Invoke(InternalObj); }
      set { Api.TouchElementBase_SetMargin.Invoke(InternalObj, value); }
    }
    ...
    {
      get { return Api.TouchElementBase_GetScale.Invoke(InternalObj); }
      set { Api.TouchElementBase_SetScale.Invoke(InternalObj, value); }
    }
    ...
    {
      get { return Api.TouchElementBase_GetPixels.Invoke(InternalObj); }
      set { Api.TouchElementBase_SetPixels.Invoke(InternalObj, value); }
    }
    ...
    public TouchApp App
    {
      ...
      {
        return _app ?? (_app =
          Wrap(Api.TouchElementBase_GetApp.Invoke(InternalObj), (obj) => new TouchApp(obj)));
      }
    }
    ...
    /// </summary>
    public TouchView Parent
    {
      get
      {
        return _parent ?? (_parent = Wrap(Api.TouchElementBase_GetParent.Invoke(InternalObj),
          (obj) => new TouchView(obj)));
      }
    }
  ...
  public abstract class TouchContainerBase : TouchElementBase
  {
    ...
    public List<object> Children => Api.TouchContainerBase_GetChildren.Invoke(InternalObj);
    ...
    public void AddChild(TouchElementBase child) =>
      Api.TouchContainerBase_AddChild.Invoke(InternalObj, child.InternalObj);

    public void AddChild(TouchElementBase child, int index) =>
      Api.TouchContainerBase_AddChildAt.Invoke(InternalObj, child.InternalObj, index);

    public void RemoveChild(TouchElementBase child) =>
      Api.TouchContainerBase_RemoveChild.Invoke(InternalObj, child.InternalObj);
    ...
    public void MoveChild(TouchElementBase child, int index) =>
      Api.TouchContainerBase_MoveChild.Invoke(InternalObj, child.InternalObj, index);
  }
  ...
  {
    public TouchView(ViewDirection direction = ViewDirection.Column, Color? bgColor = null) : base(
      Api.TouchView_New((byte) direction, bgColor))
    {
    }
    ...
    {
      get { return Api.TouchView_GetOverflow.Invoke(InternalObj); }
      set { Api.TouchView_SetOverflow.Invoke(InternalObj, value); }
    }

    public ViewDirection Direction
    {
      get { return (ViewDirection) Api.TouchView_GetDirection.Invoke(InternalObj); }
      set { Api.TouchView_SetDirection.Invoke(InternalObj, (byte) value); }
    }
    ...
    {
      get { return (ViewAlignment) Api.TouchView_GetAlignment.Invoke(InternalObj); }
      set { Api.TouchView_SetAlignment.Invoke(InternalObj, (byte) value); }
    }
    ...
    {
      get { return (ViewAnchor) Api.TouchView_GetAnchor.Invoke(InternalObj); }
      set { Api.TouchView_SetAnchor.Invoke(InternalObj, (byte) value); }
    }
    ...
    {
      get { return Api.TouchView_GetUseThemeColors.Invoke(InternalObj); }
      set { Api.TouchView_SetUseThemeColors.Invoke(InternalObj, value); }
    }

    public Color BgColor
    {
      get { return Api.TouchView_GetBgColor.Invoke(InternalObj); }
      set { Api.TouchView_SetBgColor.Invoke(InternalObj, value); }
    }

    public Color BorderColor
    {
      get { return Api.TouchView_GetBorderColor.Invoke(InternalObj); }
      set { Api.TouchView_SetBorderColor.Invoke(InternalObj, value); }
    }
    ...
    {
      get { return Api.TouchView_GetBorder.Invoke(InternalObj); }
      set { Api.TouchView_SetBorder.Invoke(InternalObj, value); }
    }
    ...
    {
      get { return Api.TouchView_GetPadding.Invoke(InternalObj); }
      set { Api.TouchView_SetPadding.Invoke(InternalObj, value); }
    }
    ...
    public int Gap
    {
      get { return Api.TouchView_GetGap.Invoke(InternalObj); }
      set { Api.TouchView_SetGap.Invoke(InternalObj, value); }
    }
  }
  ...
  {
    TouchBarContainer _scrollBar;

    public TouchScrollView(ViewDirection direction = ViewDirection.Column, Color? bgColor = null) : base(
      Api.TouchScrollView_New((int) direction, bgColor))
    {
    }
    ...
    public float Scroll
    {
      get { return Api.TouchScrollView_GetScroll.Invoke(InternalObj); }
      set { Api.TouchScrollView_SetScroll.Invoke(InternalObj, value); }
    }

    public bool ScrollAlwaysVisible
    {
      get { return Api.TouchScrollView_GetScrollAlwaysVisible.Invoke(InternalObj); }
      set { Api.TouchScrollView_SetScrollAlwaysVisible.Invoke(InternalObj, value); }
    }
    ...
    public TouchBarContainer ScrollBar
    {
      get
      {
        return _scrollBar ?? (_scrollBar = Wrap(Api.TouchScrollView_GetScrollBar.Invoke(InternalObj),
          (obj) => new TouchBarContainer(obj)));
      }
    }
  }
  ...
  public class TouchApp : TouchView
  {
    ...
    public TouchScreen Screen
    {
      get
      {
        return _screen ?? (_screen =
          Wrap(Api.TouchApp_GetScreen.Invoke(InternalObj), (obj) => new TouchScreen(obj)));
      }
    }

    public RectangleF Viewport => Api.TouchApp_GetViewport.Invoke(InternalObj);
    ...
    public TouchCursor Cursor
    {
      get
      {
        return _cursor ?? (_cursor =
          Wrap(Api.TouchApp_GetCursor.Invoke(InternalObj), (obj) => new TouchCursor(obj)));
      }
    }

    public TouchTheme Theme
    {
      get
      {
        return _theme ?? (_theme =
          Wrap(Api.TouchApp_GetTheme.Invoke(InternalObj), (obj) => new TouchTheme(obj)));
      }
    }
    ...
    {
      get { return Api.TouchApp_GetDefaultBg.Invoke(InternalObj); }
      set { Api.TouchApp_SetDefaultBg.Invoke(InternalObj, value); }
    }
    ...
    public virtual void InitApp(IMyCubeBlock block, IMyTextSurface surface) =>
      Api.TouchApp_InitApp.Invoke(InternalObj, block, surface);
  }
  ...
  public class TouchEmptyButton : TouchView
  {
    ...
    public ClickHandler Handler
    {
      get
      {
        return _handler ?? (_handler = Wrap(Api.TouchEmptyButton_GetHandler.Invoke(InternalObj),
          (obj) => new ClickHandler(obj)));
      }
    }

    public Action OnChange
    {
      set { Api.TouchEmptyButton_SetOnChange.Invoke(InternalObj, value); }
    }
  }
    ...
    public TouchLabel Label
    {
      get
      {
        return _label ?? (_label =
          Wrap(Api.TouchButton_GetLabel.Invoke(InternalObj), (obj) => new TouchLabel(obj)));
      }
    }
  }
  ...
  public class TouchCheckbox : TouchView
  {
    ...
    public bool Value
    {
      get { return Api.TouchCheckbox_GetValue.Invoke(InternalObj); }
      set { Api.TouchCheckbox_SetValue.Invoke(InternalObj, value); }
    }

    public Action<bool> OnChange
    {
      set { Api.TouchCheckbox_SetOnChange.Invoke(InternalObj, value); }
    }
    ...
    public TouchEmptyElement CheckMark
    {
      get
      {
        return _checkMark ?? (_checkMark = Wrap(Api.TouchCheckbox_GetCheckMark.Invoke(InternalObj),
          (obj) => new TouchEmptyElement(obj)));
      }
    }
  }
  ...
  {
    public TouchLabel(string text, float fontSize = 0.5f, TextAlignment alignment = TextAlignment.CENTER) : base(
      Api.TouchLabel_New(text, fontSize, alignment))
    {
    }
    ...
    public bool AutoBreakLine
    {
      get { return Api.TouchLabel_GetAutoBreakLine.Invoke(InternalObj); }
      set { Api.TouchLabel_SetAutoBreakLine.Invoke(InternalObj, value); }
    }

    /// <summary>
    /// If true, text will not be shortened if bigger than size.
    /// </summary>
    public LabelEllipsis AutoEllipsis
    {
      get { return (LabelEllipsis) Api.TouchLabel_GetAutoEllipsis.Invoke(InternalObj); }
      set { Api.TouchLabel_SetAutoEllipsis.Invoke(InternalObj, (byte) value); }
    }

    /// <summary>
    /// If <see cref="AutoEllipsis" /> is false and the text was limited to fit the size and added an ellipsis.
    /// </summary>
    public bool HasEllipsis => Api.TouchLabel_GetHasEllipsis.Invoke(InternalObj);

    public string Text
    {
      get { return Api.TouchLabel_GetText.Invoke(InternalObj); }
      set { Api.TouchLabel_SetText.Invoke(InternalObj, value); }
    }

    public Color? TextColor
    {
      get { return Api.TouchLabel_GetTextColor.Invoke(InternalObj); }
      set { Api.TouchLabel_SetTextColor.Invoke(InternalObj, (Color) value); }
    }

    public float FontSize
    {
      get { return Api.TouchLabel_GetFontSize.Invoke(InternalObj); }
      set { Api.TouchLabel_SetFontSize.Invoke(InternalObj, value); }
    }

    public TextAlignment Alignment
    {
      get { return Api.TouchLabel_GetAlignment.Invoke(InternalObj); }
      set { Api.TouchLabel_SetAlignment.Invoke(InternalObj, value); }
    }
  }
  ...
  public class TouchBarContainer : TouchView
  {
    ...
    {
      get { return Api.TouchBarContainer_GetIsVertical.Invoke(InternalObj); }
      set { Api.TouchBarContainer_SetIsVertical.Invoke(InternalObj, value); }
    }
    ...
    public float Ratio
    {
      get { return Api.TouchBarContainer_GetRatio.Invoke(InternalObj); }
      set { Api.TouchBarContainer_SetRatio.Invoke(InternalObj, value); }
    }
    ...
    public float Offset
    {
      get { return Api.TouchBarContainer_GetOffset.Invoke(InternalObj); }
      set { Api.TouchBarContainer_SetOffset.Invoke(InternalObj, value); }
    }
    ...
    public TouchView Bar
    {
      ...
      {
        return _bar ?? (_bar =
          Wrap(Api.TouchBarContainer_GetBar.Invoke(InternalObj), (obj) => new TouchView(obj)));
      }
    }
  }
  ...
  public class TouchProgressBar : TouchBarContainer
  {
    ...
    public TouchProgressBar(float min, float max, bool vertical = false, float barsGap = 0) : base(
      Api.TouchProgressBar_New(min, max, vertical, barsGap))
    {
    }
    ...
    public float Value
    {
      get { return Api.TouchProgressBar_GetValue.Invoke(InternalObj); }
      set { Api.TouchProgressBar_SetValue.Invoke(InternalObj, value); }
    }

    public float MaxValue
    {
      get { return Api.TouchProgressBar_GetMaxValue.Invoke(InternalObj); }
      set { Api.TouchProgressBar_SetMaxValue.Invoke(InternalObj, value); }
    }

    public float MinValue
    {
      get { return Api.TouchProgressBar_GetMinValue.Invoke(InternalObj); }
      set { Api.TouchProgressBar_SetMinValue.Invoke(InternalObj, value); }
    }

    public float BarsGap
    {
      get { return Api.TouchProgressBar_GetBarsGap.Invoke(InternalObj); }
      set { Api.TouchProgressBar_SetBarsGap.Invoke(InternalObj, value); }
    }
    ...
    public TouchLabel Label
    {
      get
      {
        return _label ?? (_label = Wrap(Api.TouchProgressBar_GetLabel.Invoke(InternalObj),
          (obj) => new TouchLabel(obj)));
      }
    }
  }
  ...
  {
    public TouchSelector(List<string> labels, Action<int, string> onChange, bool loop = true) : base(
      Api.TouchSelector_New(labels, onChange, loop))
    {
    }
    ...
    public bool Loop
    {
      get { return Api.TouchSelector_GetLoop.Invoke(InternalObj); }
      set { Api.TouchSelector_SetLoop.Invoke(InternalObj, value); }
    }

    public int Selected
    {
      get { return Api.TouchSelector_GetSelected.Invoke(InternalObj); }
      set { Api.TouchSelector_SetSelected.Invoke(InternalObj, value); }
    }

    public Action<int, string> OnChange
    {
      set { Api.TouchSelector_SetOnChange.Invoke(InternalObj, value); }
    }
  }
  ...
  {
    TouchBarContainer _bar;
    TouchEmptyElement _thumb;
    TouchTextField _textInput;
    ...
    public float MaxValue
    {
      get { return Api.TouchSlider_GetMaxValue.Invoke(InternalObj); }
      set { Api.TouchSlider_SetMaxValue.Invoke(InternalObj, value); }
    }

    public float MinValue
    {
      get { return Api.TouchSlider_GetMinValue.Invoke(InternalObj); }
      set { Api.TouchSlider_SetMinValue.Invoke(InternalObj, value); }
    }

    public float Value
    {
      get { return Api.TouchSlider_GetValue.Invoke(InternalObj); }
      set { Api.TouchSlider_SetValue.Invoke(InternalObj, value); }
    }

    public bool IsInteger
    {
      get { return Api.TouchSlider_GetIsInteger.Invoke(InternalObj); }
      set { Api.TouchSlider_SetIsInteger.Invoke(InternalObj, value); }
    }
    ...
    {
      get { return Api.TouchSlider_GetAllowInput.Invoke(InternalObj); }
      set { Api.TouchSlider_SetAllowInput.Invoke(InternalObj, value); }
    }

    public Action<float> OnChange
    {
      set { Api.TouchSlider_SetOnChange.Invoke(InternalObj, value); }
    }
    ...
    public TouchBarContainer Bar
    {
      get
      {
        return _bar ?? (_bar = Wrap(Api.TouchSlider_GetBar.Invoke(InternalObj),
          (obj) => new TouchBarContainer(obj)));
      }
    }
    ...
    public TouchEmptyElement Thumb
    {
      get
      {
        return _thumb ?? (_thumb = Wrap(Api.TouchSlider_GetThumb.Invoke(InternalObj),
          (obj) => new TouchEmptyElement(obj)));
      }
    }

    public TouchTextField TextInput
    {
      get
      {
        return _textInput ?? (_textInput = Wrap(Api.TouchSlider_GetTextInput.Invoke(InternalObj),
          (obj) => new TouchTextField(obj)));
      }
    }
  }
  ...
  {
    TouchEmptyElement _thumbLower;

    public TouchSliderRange(float min, float max, Action<float, float> onChange) : base(
      Api.TouchSliderRange_NewR(min, max, onChange))
    {
    }
    ...
    {
      get { return Api.TouchSliderRange_GetValueLower.Invoke(InternalObj); }
      set { Api.TouchSliderRange_SetValueLower.Invoke(InternalObj, value); }
    }

    public Action<float, float> OnChangeRange
    {
      set { Api.TouchSliderRange_SetOnChangeR.Invoke(InternalObj, value); }
    }
    ...
    public TouchEmptyElement ThumbLower
    {
      get
      {
        return _thumbLower ?? (_thumbLower =
          Wrap(Api.TouchSliderRange_GetThumbLower.Invoke(InternalObj),
            (obj) => new TouchEmptyElement(obj)));
      }
    }
  }
  ...
  public class TouchSwitch : TouchView
  {
    ...
    public TouchSwitch(string[] labels, int index = 0, Action<int> onChange = null) : base(
      Api.TouchSwitch_New(labels, index, onChange))
    {
    }
    ...
    public int Index
    {
      get { return Api.TouchSwitch_GetIndex.Invoke(InternalObj); }
      set { Api.TouchSwitch_SetIndex.Invoke(InternalObj, value); }
    }
    ...
    public TouchButton[] Buttons
    {
      get
      {
        return _buttons ?? (_buttons = WrapArray(Api.TouchSwitch_GetButtons.Invoke(InternalObj),
          (obj) => new TouchButton(obj)));
      }
    }

    public Action<int> OnChange
    {
      set { Api.TouchSwitch_SetOnChange.Invoke(InternalObj, value); }
    }
  }
  ...
  public class TouchTextField : TouchView
  {
    ...
    public bool IsEditing => Api.TouchTextField_GetIsEditing.Invoke(InternalObj);

    public string Text
    {
      get { return Api.TouchTextField_GetText.Invoke(InternalObj); }
      set { Api.TouchTextField_SetText.Invoke(InternalObj, value); }
    }

    public bool IsNumeric
    {
      get { return Api.TouchTextField_GetIsNumeric.Invoke(InternalObj); }
      set { Api.TouchTextField_SetIsNumeric.Invoke(InternalObj, value); }
    }

    public bool IsInteger
    {
      get { return Api.TouchTextField_GetIsInteger.Invoke(InternalObj); }
      set { Api.TouchTextField_SetIsInteger.Invoke(InternalObj, value); }
    }

    public bool AllowNegative
    {
      get { return Api.TouchTextField_GetAllowNegative.Invoke(InternalObj); }
      set { Api.TouchTextField_SetAllowNegative.Invoke(InternalObj, value); }
    }
    ...
    public TouchLabel Label
    {
      ...
      {
        return _label ?? (_label =
          Wrap(Api.TouchTextField_GetLabel.Invoke(InternalObj), (obj) => new TouchLabel(obj)));
      }
    }

    public Action<string, bool> OnChange
    {
      set { Api.TouchTextField_SetOnChange.Invoke(InternalObj, value); }
    }
  }
  ...
  public class TouchWindowBar : TouchView
  {
    ...
    public TouchLabel Label
    {
      ...
      {
        return _label ?? (_label =
          Wrap(Api.TouchWindowBar_GetLabel.Invoke(InternalObj), (obj) => new TouchLabel(obj)));
      }
    }
  }
  ...
  public class TouchChart : TouchElementBase
  {
    ...
    public List<float[]> DataSets => Api.TouchChart_GetDataSets.Invoke(InternalObj);

    public List<Color> DataColors => Api.TouchChart_GetDataColors.Invoke(InternalObj);

    public int GridHorizontalLines
    {
      get { return Api.TouchChart_GetGridHorizontalLines.Invoke(InternalObj); }
      set { Api.TouchChart_SetGridHorizontalLines.Invoke(InternalObj, value); }
    }

    public int GridVerticalLines
    {
      get { return Api.TouchChart_GetGridVerticalLines.Invoke(InternalObj); }
      set { Api.TouchChart_SetGridVerticalLines.Invoke(InternalObj, value); }
    }

    public float MaxValue => Api.TouchChart_GetMaxValue.Invoke(InternalObj);

    public float MinValue => Api.TouchChart_GetMinValue.Invoke(InternalObj);

    public Color? GridColor
    {
      get { return Api.TouchChart_GetGridColor.Invoke(InternalObj); }
      set { Api.TouchChart_SetGridColor.Invoke(InternalObj, (Color) value); }
    }
  }
